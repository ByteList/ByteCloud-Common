 ...
 */
public class CloudPlayerLocationPacket implements Packet {
    ...
    private CloudPlayerLocationPacket() {
    }

    public CloudPlayerLocationPacket(UUID uuid, CloudLocation location) {
        this.uuid = uuid;
